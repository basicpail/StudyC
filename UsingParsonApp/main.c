/*
  filename - main.c
  version - 1.0
  description - 기본 메인 함수, parson사용 예제
  --------------------------------------------------------------------------------
...
void write_json(void)
{
    ...
    json_object_set_string(rootObject, "Genre", "SF");
    json_object_set_string(rootObject, "Director", "SF");
    ...
    json_array_append_string(actors, "Matthew Mcdonald");
    json_array_append_string(actors, "Matthew McCony");
    json_array_append_string(actors, "Matthew Canie");
    json_array_append_string(actors, "Matthew Christin");
